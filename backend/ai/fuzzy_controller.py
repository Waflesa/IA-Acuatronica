...
if __name__ == "__main__":
    # Prueba unitaria del controlador difuso
    controller = FuzzyAcuaponiaController()
    
    # Escenario de prueba: Agua fría (15°C), Oxígeno crítico (2.5 mg/L) y Amonio elevado (2.5 mg/L)
    test_result = controller.evaluate(
        temperature=15.0,
    ...
    print("\n--- Resultado de la Evaluación Difusa ---")
    print(f"Tasa de Aireación: {test_result['aeration_rate']}%")
    print(f"Potencia de Calefacción: {test_result['heating_power']}%")
    print(f"Flujo de Recirculación: {test_result['recirculation_flow']}%\n")